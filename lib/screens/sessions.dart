        ...
        children: [
          Card(
            child: ListTile(
              ...
              title: const Text('Personal Record', style: TextStyle(fontWeight: FontWeight.w800)),
              subtitle: Text(
                _best == null
                  ? '–'
          ...
          const _Section('Volumen (letzte 30 Tage)'),
          if (_perDay.isEmpty) const Card(child: ListTile(title: Text('Keine Daten.')))
          else Card(child: SizedBox(height: 220, child: _volumeLineChart())),

          const _Section('Satzanzahl pro Tag'),
          if (_perDay.isEmpty) const Card(child: ListTile(title: Text('Keine Daten.')))
          else Card(child: SizedBox(height: 220, child: _setsBarChart())),

          const _Section('Letzte Sätze'),
          if (_recent.isEmpty)
            const Card(child: ListTile(title: Text('Keine Daten.')))
          else
            Card(
              child: Column(
